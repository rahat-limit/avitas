...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => _RouteErrorBuilder(
        state: state,
        child: appStateNotifier.loggedIn ? NavBarPage() : Auth2LoginWidget(),
      ),
      routes: [
        FFRoute(
          name: '_initialize',
        ...
        FFRoute(
          ...
          asyncParams: {
            ...
            'worker': getDoc(['job', 'worker'], WorkerRecord.fromSnapshot),
          },
        ...
        FFRoute(
          ...
          builder: (context, params) => PaymentRecievedWidget(
            job: params.getParam(
              'job',
              ParamType.Document,
            ),
            paymentDate: params.getParam(
              'paymentDate',
              ParamType.DateTime,
            ),
          ),
